...
export const styles = StyleSheet.create({
    ...
    boutonVide: { backgroundColor: 'transparent', width: '100%', maxWidth: 360, paddingVertical: 18, borderRadius: 12, alignItems: 'center', borderWidth: 1, borderColor: '#555' },
    texteBoutonVide: { color: '#AAA', fontWeight: 'bold' },
    ...
    cadreImage: { width: '100%', maxWidth: 360, height: 200, backgroundColor: '#111', borderRadius: 12, justifyContent: 'center', alignItems: 'center', marginBottom: 20, borderWidth: 1, borderColor: '#222' },
    boiteStatut: { flexDirection: 'row', backgroundColor: '#111', padding: 12, borderRadius: 8, marginBottom: 25, width: '100%', maxWidth: 360, alignItems: 'center', borderWidth: 1, borderColor: '#222' },
